...
import Afferent.UI.Canopy.Widget.Input.Slider
import Afferent.UI.Canopy.Widget.Input.Switch
import Afferent.UI.Canopy.Widget.Input.Stepper
import Afferent.UI.Canopy.Widget.Input.RangeSlider
import Afferent.UI.Canopy.Widget.Input.RadioButton
import Afferent.UI.Canopy.Widget.Input.DatePicker
import Afferent.UI.Canopy.Widget.Input.TimePicker
import Afferent.UI.Canopy.Widget.Navigation.Pagination
import Afferent.UI.Canopy.Widget.Layout.SplitPane
import Afferent.UI.Canopy.Widget.Layout.Popover
import Afferent.UI.Canopy.Widget.Display.Avatar
import Afferent.UI.Canopy.Widget.Display.Badge
import Trellis

namespace AfferentTests.WidgetCoverageTests
...
test "Badge variant color helpers map to expected palette" := do
  ...
  ensure (Badge.variantTextColor testTheme .error == Afferent.Color.white) "Badge text color should be white"

end AfferentTests.WidgetCoverageTests
