...
end ImageGenTests.CLI

namespace ImageGenTests.Base64
...
end ImageGenTests.Base64

namespace ImageGenTests.ImageInput
...
end ImageGenTests.ImageInput

namespace ImageGenTests.Batch
