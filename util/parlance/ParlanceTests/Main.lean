...
-- Core Types Tests
namespace ParlanceTests.CoreTypes
...
end ParlanceTests.CoreTypes

-- Tokenizer Tests
namespace ParlanceTests.Tokenizer
...
end ParlanceTests.Tokenizer

-- Parser Tests
namespace ParlanceTests.Parser
...
end ParlanceTests.Parser

-- Extractor Tests
namespace ParlanceTests.Extractor
...
end ParlanceTests.Extractor

-- Style Tests
namespace ParlanceTests.Style
...
end ParlanceTests.Style

-- Command Builder Tests
namespace ParlanceTests.CommandBuilder
...
end ParlanceTests.CommandBuilder

-- Help Generation Tests
namespace ParlanceTests.HelpGeneration
...
end ParlanceTests.HelpGeneration

-- Environment Variable Tests
namespace ParlanceTests.EnvVar
...
end ParlanceTests.EnvVar

-- Repeatable Flag Tests
namespace ParlanceTests.RepeatableFlags
...
end ParlanceTests.RepeatableFlags

-- Table Tests
namespace ParlanceTests.Tables
...
end ParlanceTests.Tables

-- Completion Tests
namespace ParlanceTests.Completion
...
end ParlanceTests.Completion

-- REPL LineBuffer Tests
namespace ParlanceTests.LineBuffer
...
end ParlanceTests.LineBuffer

-- REPL Input Tests
namespace ParlanceTests.ReplInput
...
end ParlanceTests.ReplInput

-- Markdown Tests
namespace ParlanceTests.Markdown
